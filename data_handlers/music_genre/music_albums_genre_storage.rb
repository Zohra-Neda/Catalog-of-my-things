...
module MusicGenreStorage
  ...
  def save_music_albums
    ...
    save_file('store_data/music_albums.json', json_data)
  end
  ...
  def save_genres
    ...
    save_file('store_data/genres.json', json_data)
  end
  ...
  def load_music_albums
    music_albums_hash = []
    return music_albums_hash unless File.exist?('store_data/music_albums.json')

    music_albums_hash = load_data_from_file('store_data/music_albums.json')
  ...
  def load_genres
    genre_hash = []
    return genre_hash unless File.exist?('store_data/genres.json')

    genre_hash = load_data_from_file('store_data/genres.json')
